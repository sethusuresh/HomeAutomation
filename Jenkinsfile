    ...
    stages {
        ...
        stage('Deploy') {
            steps {
	            ...
	            sshCommand remote: remote, command: 'docker run --name home_automation -p 9090:9090 --mount type=volume,source=home_automation,target=/log -d sethusuresh/home_automation'
            }
        }
    }
    post { 
